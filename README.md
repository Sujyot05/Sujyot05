...
I am **Sujyot Bhandare**, a Computer Engineering student at MESWCOE, Pune, with a background in Information Technology from Sinhgad Institute. I bridge the gap between complex engineering and user-centric business goals.

---

### Professional Profile
- **Education:** BE in Computer Engineering (MESWCOE); Diploma in IT (SVCP).
- **Current Focus:** Building real-world applications and exploring Product Strategy.
- **Objective:** Seeking opportunities as an Associate Product Manager (APM) or Product Manager.
- **Philosophy:** Building products is about insights, growth, and solving user pain points.
